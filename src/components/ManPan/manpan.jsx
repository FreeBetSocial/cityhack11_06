...
import image46 from "../../img/image_46.png"
import image54 from "../../img/image_54.png"
                                    ...
                                    <tbody>
                                        {items.map((e,i)=>(
                                            <tr key={i}>
                                                ...
                                                <td>
                                                    <div>Отработано часов: <input type="number"  step={1}  min={0} max={12}/></div>
                                                </td>
                                                <td>
                                                    <p style={{
                                                        color:e.start?"#5CBF41":"#AD2929"
                                                    }}>{e.start?"Присутствовал":"Отсутствовал"}</p>
                                                </td>
                                            </tr>
                                        ))}
                                    </tbody>
                                ...
                                <div className={classes.col_items1}>
                                    ...
                                    <div className={classes.row_ittems}>
                                        <div className={classes.row_it2}>
                                            ...
                                            <h4>г. Ростов-на-Дону, пл. Гагарина 1</h4>
                                        </div> 
                                        <div className={classes.row_it2}>
